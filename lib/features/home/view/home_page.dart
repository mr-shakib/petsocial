...
const _mockPosts = [
  (
    image: 'https://loremflickr.com/400/450/dog?lock=11',
    pet: 'Hunter',
    owner: 'Jacob William',
    avatar: 'https://loremflickr.com/100/100/dog?lock=11',
    reactions: '12.3k',
    comments: '103',
  ),
  (
    image: 'https://loremflickr.com/400/450/cat?lock=22',
    pet: 'Luna',
    owner: 'Sarah Connor',
    avatar: 'https://loremflickr.com/100/100/cat?lock=22',
    reactions: '8.1k',
    comments: '74',
  ),
  (
    image: 'https://loremflickr.com/400/450/dog?lock=33',
    pet: 'Max',
    owner: 'Emily Davis',
    avatar: 'https://loremflickr.com/100/100/dog?lock=33',
    reactions: '5.2k',
    comments: '48',
  ),
  (
    image: 'https://loremflickr.com/400/450/cat?lock=44',
    pet: 'Bella',
    owner: 'Chris Brown',
    avatar: 'https://loremflickr.com/100/100/cat?lock=44',
    reactions: '9.7k',
    comments: '91',
  ),
];
